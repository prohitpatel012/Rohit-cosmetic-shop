...
import { X, Plus, Minus, ShoppingBag, MessageCircle, Phone, MapPin } from 'lucide-react';
...
export default function CartDrawer() {
  ...
  const handleOrderWhatsApp = () => {
    const phoneNumber = "917071853247"; // Replace with real WhatsApp number
          ...
          <div className="p-4 sm:p-6 bg-gray-50 border-t border-gray-100">
            ...
            <div className="bg-white border border-gray-200 rounded-xl p-4 mb-4 shadow-sm">
              <div className="flex items-start gap-3 mb-3 pb-3 border-b border-gray-100">
                ...
                <div>
                  <p className="text-sm font-semibold text-gray-900 mb-0.5">Visit Our Shop</p>
                  <p className="text-xs text-gray-600">barahi kala 221207</p>
                </div>
              </div>
              ...
              <div className="flex items-start gap-3">
                ...
                <div>
                  ...
                  <a href="tel:7071853247" className="text-xs text-blue-600 hover:underline font-medium">
                    +91 7071853247
                  </a>
                </div>
              </div>
            ...
            <div className="flex flex-col gap-2.5">
              ...
              <a
                href="tel:7071853247"
                className="w-full bg-gray-900 hover:bg-gray-800 text-white font-bold py-3.5 px-4 rounded-xl flex items-center justify-center gap-2 transition-all shadow-md active:scale-[0.98]"
              >
